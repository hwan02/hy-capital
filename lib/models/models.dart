...
class Zone {
  ...
  /// 모아타운 진행 단계. 교안 「단계별 시세 그래프(모아타운)」의 x축 그대로.
  ///   동의서징구시작 → 동의서달성 → 신규 선정 → «관리계획 수립» →
  ///   통합심의 → 관리계획 승인고시 → «조합 동의서 징구» → 조합설립인가
  /// 그 뒤(건축심의~준공)는 그래프 밖이지만 진행 추적을 위해 이어 붙였다.
  ...
  ///   동의서징구시작 → 동의서달성 → 신규선정 → 토허가 발효 → «기획 완료» →
  ///   정비구역 지정고시 → «동의서 징구» → 조합설립인가 → 사업시행인가
  /// 모아와 «골짜기 위치가 다르다» — 그래서 축을 따로 쓴다.
