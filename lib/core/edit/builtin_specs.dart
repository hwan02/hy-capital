...
const ipoSpec = BuiltinSpec(
  ...
  fields: [
    ...
    FieldSpec(key: 'sub_start', label: '청약 시작', type: FieldType.date),
    FieldSpec(key: 'sub_end', label: '청약 마감', type: FieldType.date),
    FieldSpec(key: 'refund_date', label: '환불일', type: FieldType.date),
    FieldSpec(key: 'listing_date', label: '상장일', type: FieldType.date),
    FieldSpec(key: 'band_low', label: '희망공모가 하단', type: FieldType.money),
    FieldSpec(key: 'band_high', label: '희망공모가 상단', type: FieldType.money),
