...
from (values
  ...
  ('2026-10-01','조정대상 일시적 2주택 종전주택 처분기간 3년→2년','조정대상지역에서 신규 취득 후 종전주택을 2년 내 팔아야 일시적 2주택 비과세 유지.','세제','true','2026 세제개편안(8.3)'),
  ('2027-01-01','고가·비거주 종부세 핀셋 인상 (1주택 공제 차등)','1세대1주택 기본공제를 실거주 14억(상향)·비거주 9억(하향)으로 차등. 공정시장가액비율 60%→70%. 실거주 1주택은 완화, 고가·비거주·다주택은 보유세 인상.','세제','true','2026 세제개편안(8.3)'),
  ('2027-01-01','다주택 양도세 중과 한시 완화 (2027~2028)','조정대상 다주택 양도세 중과: 2주택 +20%p→+5%p, 3주택↑ +30%p→+10%p로 한시 인하(2028년 일부 환원). 처분 유도.','세제','true','2026 세제개편안(8.3)'),
  ('2028-01-01','종부세 공정시장가액비율 80% (3주택↑·조정대상)','3주택 이상 및 조정대상지역 보유자는 공정시장가액비율 80% 적용. 세율은 주택가액 기준 일원화.','세제','true','2026 세제개편안(8.3)'),
  ('2028-01-01','장특공 → 장기거주 소득공제 개편 (보유공제→거주공제·비과세 요건 강화)','1주택 장기보유특별공제를 거주기간 중심 장기거주 소득공제로 개편. 10년 이상 거주·양도가 30억↓ 1주택 기본공제 연 2,500만 확대. 실거주 안 하면 공제 축소.','세제','true','2026 세제개편안(8.3)')
